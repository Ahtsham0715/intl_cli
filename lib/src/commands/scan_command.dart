...
class ScanCommand extends Command {
  ...
  @override
  final description =
      'Scan project for hardcoded strings that can be internationalized';
  ...
  ScanCommand() {
    ...
    argParser.addFlag('verbose',
        abbr: 'v', help: 'Display detailed information about found strings');
    ...
    try {
      ...
      if (verbose) {
        ...
        for (final file in extractedStrings.keys) {
          final shortPath = file.replaceAll(nonNullDir, '');
          print(
              '- \u001b[36m$shortPath\u001b[0m (${extractedStrings[file]!.length} strings)');
        }
      }
    } on FileSystemException catch (e) {
      stderr
          .writeln('\u001b[31mError: Directory not found: ${e.path}\u001b[0m');
